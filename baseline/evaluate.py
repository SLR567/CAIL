...
if __name__ == '__main__':
    if(len(sys.argv) > 1):
        ...
        #modelpred = '/home/ubuntu-user/NLP_5/baseline/output/submissions/train_v1/pred_seed_26_epoch_10_99999.json'
        modelpred = 'output/submissions/train_chinese_roberta_wwm_ext_mergeData/pred_seed_0_epoch_20_99999.json'
        gold = 'dev.json'
        eval(modelpred, gold)
